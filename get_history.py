...
def get_migration_duration(application_id, df_history):
    ...
    new_row = [application_id, representation_of_states_str, assessment_duration, migration_execution_duration]
...
# MAIN
list_of_apps = [83460, 94875, 90320]
for app_id in list_of_apps:
    df_history = get_migration_duration(app_id, df_history)
